...
namespace Radhey.Repository.Implementation.AccountRepo
{
    public class CustomUserManager : ICustomUserManager
    {
        ...
        public CustomUserManager(UserManager<TblApplicationUser> userManager
        ...
        #region CreateAsync
        public async Task<IdentityResult> GetCreateAsync(TblApplicationUser user)
        {
        ...
        public async Task<IdentityResult> GetCreateAsync(TblApplicationUser user, string password)
        {
